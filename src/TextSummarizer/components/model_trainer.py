...
import os  # ✅ Fix: required for saving model
import torch
from transformers import TrainingArguments, Trainer
from transformers import DataCollatorForSeq2Seq
from transformers import AutoModelForSeq2SeqLM, AutoTokenizer
...
class ModelTrainer:
    ...
    def train(self):
        ...
        trainer = Trainer(
            ...
            train_dataset=dataset["test"],        # ✅ test split used only because of comptational difficulty
